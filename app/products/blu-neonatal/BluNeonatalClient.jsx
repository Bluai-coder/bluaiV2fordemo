...
const ProductGallery = () => {
    ...
    const galleryItems = [
        ...
        { type: 'image', label: 'Side View', src: '/neonatal/1.webp', transform: 'bottom' },
        { type: 'image', label: 'Front View', src: '/neonatal/2.webp', transform: 'bottom' },
