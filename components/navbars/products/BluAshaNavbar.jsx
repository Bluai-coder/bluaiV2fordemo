...
export default function BluAshaNavbar() {
                    ...
                    <Collapse in={mobileProductsOpen} timeout="auto" unmountOnExit>
                        <Box sx={{ pl: 2 }}>
                            ...
                            <ListItemButton
                                ...
                                onClick={() => setMobileOpen(false)}
                            >
                                <ListItemText primary="SmartPole™" />
                            </ListItemButton>
                            ...
                            <ListItemButton
                                ...
                                onClick={() => setMobileOpen(false)}
                            >
                                <ListItemText primary="BluGlucose™" />
                            </ListItemButton>
                            ...
                            <ListItemButton
                                ...
                                onClick={() => setMobileOpen(false)}
                            >
                                <ListItemText primary="BluECG™ (Wireless ECG)" />
                            </ListItemButton>
