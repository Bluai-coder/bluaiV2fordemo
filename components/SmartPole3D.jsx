...
const PoleViewer = dynamic(() => import('@/components/PoleViewer'), {
    ssr: false,
    loading: () => (
...
export default function SmartPole3D() { 
    // Try both paths
    const modelPath = '/models/smartpole.glb';  // This should work

    return (
        <PoleViewer modelPath={modelPath} />
    );
}