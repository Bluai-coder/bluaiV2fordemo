...
//     return (
//         <Box sx={{ py: 12, bgcolor: "#05070b", color: "#fff" }}>
...
//                         {/* Arrow Segments */}
//                         {/* {createArrows(260, 260, 190, 6)} */}
//                     </svg>
//                 </Box>
//             </Container>
//             <StepsExplain

//                 data={data} handleClose={handleClose} open={open}
//             />
//         </Box>
//     );
// }
...
// function StepBox({ step, text, sx, handleClickOpen }) {
//     return (
//         <Paper
//             elevation={0}
